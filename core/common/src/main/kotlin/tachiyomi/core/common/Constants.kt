...
object Constants {
    const val URL_HELP = "https://github.com/rahulrajarapu158-arch/ytclip-hub"
    const val URL_HELP_UPCOMING = "https://github.com/rahulrajarapu158-arch/ytclip-hub"
    const val URL_DONATE_PATREON = ""
    const val URL_DONATE_OPENCOLLECTIVE = ""
    const val URL_DISCORD = ""
